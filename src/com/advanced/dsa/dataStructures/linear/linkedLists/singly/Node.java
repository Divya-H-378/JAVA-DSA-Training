...
class LL {
    ...
    private int size;
    LL(){
        size = 0; // Initially the list is empty, so size is zero.
    }
    ...
    public class Node {
        ...
        Node(String data){
            this.data = data;
            this.next = null; // Initially the node is connected to null
    ...
    public void addFirst(String data){
        ...
        // Point the next node of new node to the list
        newNode.next = head;
    ...
    public void removeLast() {
        // Empty list -> Give a message to user
        if (head == null) {
    ...
    public void deleteTargetNode(String target){
        ...
        // if found, make the adjustment tp the nodes and pointers
        prev.next = curr.next;
        size--;
