...
public class IntegerQueue {
    private static final int MAX_SIZE = 5; // means you should not add more than 5 elements
    private int[] arr = new int[MAX_SIZE];
    private int front;
    private int rear;
    IntegerQueue(){       // for class we take like this NAME(){} -> format
    ...
    public void enqueue(int data){
        ...
        System.out.println("Enquered " + data + " to the queue.");
    }
    public void dequeue() {
        if (isEmpty()) {
