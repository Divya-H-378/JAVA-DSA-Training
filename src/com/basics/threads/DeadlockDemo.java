...
Since neither thread releases the lock, both keep waiting for
each other creating a DEADLOCK ❌🔐 Situation
...
🔷 When deadlock occurs, it will not destroy the app, it will freeze it permanently.
